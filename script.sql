...
CREATE TABLE [Post] (
    ...
    [LastUpdateDate] SMALLDATETIME NOT NULL DEFAULT '2022-12-27T17:45:13.9208051Z',
...
VALUES (N'20221227174514_InitialCreation', N'7.0.1');
GO
...
ALTER TABLE [Post] ADD DEFAULT '2022-12-27T20:24:25.4838991Z' FOR [LastUpdateDate];
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20221227202425_addicionadocampoGithub', N'7.0.1');
GO
